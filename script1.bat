...
REM ******************** LIMPAR ARQUIVOS RECENTES ********************
del /f /q %AppData%\Microsoft\Windows\Recent\*
Remove-Item -Path "$env:AppData\Microsoft\Windows\Recent\*" -Force

REM Remove os itens na lixeira de todos os usuários usando CMD
rd /s /q C:\$Recycle.Bin

REM Remove os itens na lixeira de todos os usuários usando PowerShell
powershell -Command "Get-ChildItem 'C:\$Recycle.Bin' -Force | Remove-Item -Force -Recurse"
